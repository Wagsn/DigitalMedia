...
{
    public partial class ZoomByBorderDragForm : Form
    {
        public ZoomByBorderDragForm()
        {
            InitializeComponent();

            BindBorderDragZoomEvent(this);
        }

        private void BindBorderDragZoomEvent(Control control)
        {
            //窗体中控件的事件晚期绑定
